        ...
        <>
            <nav className="navbar navbar-expand-md py-3 fixed-top backdrop-nav nav" >
                <div className="container-md container-fluid">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" onClick={toggleTheme}  width="40" height="40" fill="currentColor" className={`bi bi-asterisk text-white bg-light-${theme} rounded-5 p-2  `} viewBox="0 0 16 16">
