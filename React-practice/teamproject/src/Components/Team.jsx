        ...
        <>
            <div className='container row gap-4 m-auto justify-content-center mt-5'>
                ...
                <div class="col-5 card mb-3" style={{ maxwidth: "540px" }}>
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="src/Assets/WhatsApp Image 2023-12-18 at 18.15.21_9a5d170b.jpg" class="img-fluid rounded-start" alt="..." />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                ...
                <div class="col-5 card mb-3" style={{ maxwidth: "540px" }}>
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="src/Assets/WhatsApp Image 2024-08-20 at 22.46.42_43a63f02.jpg" class="img-fluid rounded-start" alt="..." />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
